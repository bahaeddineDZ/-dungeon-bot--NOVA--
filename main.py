...
async def revenge(ctx, target: discord.Member = None):
    ...
    save_data(data)
# تم نقل نظام الأسعار إلى shop_system.py

# تم نقل أوامر المتجر (شراء/بيع) إلى shop_system.py
...
# ----------------------------------------فاصل --------- اوامر   --------------------------
command_categories = {
        "🎯 قتال": ["حماية", "درع", "اختصاص", "انتقام", "نهب", "تحدي", "مبارزة", "سباق"],
